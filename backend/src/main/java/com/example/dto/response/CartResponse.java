...
public class CartResponse {
    ...
    /** What the user actually pays before tax. */
    ...
    public static class Builder {
        ...
        public CartResponse build() {
            return new CartResponse(cartId, userId, status, cardholder, items, distinctItemCount, totalQuantity,
                    subtotalMrp, subtotalPayable, totalSavings, totalPointsUsed);
        }
    }
}
